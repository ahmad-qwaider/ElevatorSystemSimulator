...
QT_MOC_LITERAL(3, 23, 10), // "elevatorID"
QT_MOC_LITERAL(4, 34, 7), // "arrived"
QT_MOC_LITERAL(5, 42, 5), // "floor"
QT_MOC_LITERAL(6, 48, 11), // "elvevatorID"
QT_MOC_LITERAL(7, 60, 11), // "messageToUI"
QT_MOC_LITERAL(8, 72, 7), // "message"
QT_MOC_LITERAL(9, 80, 23), // "onDoorsOpenTimerTimeout"
QT_MOC_LITERAL(10, 104, 11) // "updateFloor"

    },
    "Elevator\0floorChanged\0\0elevatorID\0"
    "arrived\0floor\0elvevatorID\0messageToUI\0"
    "message\0onDoorsOpenTimerTimeout\0"
    "updateFloor"
};
...
void Elevator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->floorChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->arrived((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->messageToUI((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->onDoorsOpenTimerTimeout(); break;
        case 4: _t->updateFloor(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::arrived)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::messageToUI)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Elevator::floorChanged(QString _t1)
{
...
// SIGNAL 1
void Elevator::arrived(int _t1, int _t2)
{
...
// SIGNAL 2
void Elevator::messageToUI(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
